...
import pcy.study.springcloudgateway.exception.AuthenticationFailedException;
    ...
    public GatewayFilter apply(Config config) {
        return (exchange, chain) -> {
            ...
            return webClient.post()
                    ...
                    .doOnError(error -> log.error("Authentication required API request failed: {}", error.getMessage()));
        };
    }
