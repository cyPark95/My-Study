...
@SpringBootTest
@Import(RawDormantBatchJob.class)
class RawDormantBatchJobTest {

    @Autowired
    private RawDormantBatchJob job;
    ...
    void batchFailsAndReturnsFailedStatus() {
        // given
        RawDormantBatchJob failedJob = new RawDormantBatchJob(null, new FakeEmailProvider());
    ...
    private static class FakeEmailProvider implements EmailProvider {
