...
public class UserOrderService {
    ...
    public UserOrder getUserOrderWithThrow(Long id, Long userId) {
        return userOrderRepository.findFirstByIdAndUserIdAndStatus(id, userId, UserOrderStatus.REGISTERED)
